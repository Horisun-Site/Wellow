...
//       <div className="flex items-center justify-between h-[110px] px-8 md:px-10">
//         {/* Logo */}
//         <div className="h-[80%] flex items-center">
//           <img className="h-[70px] w-auto" src={logo} alt="Logo" />
//         </div>

//         {/* Desktop Links */}
//         <ul className="hidden md:flex gap-7 items-center text-[15px]">
//           <Link to="/">HOME</Link>
...
//           {/* Social icons */}
//           {[{
//             move, setMove, img: facebook, hoverImg: communication, label: "facebook", link: "https://web.facebook.com/scott.emmanuel.230253/followers"
//           }, {
//             move: move1, setMove: setMove1, img: twitter, hoverImg: well, label: "twitter", link: "https://x.com/Horisun0"
//           }, {
//             move: move2, setMove: setMove2, img: instagram, hoverImg: social, label: "instagram", link: "https://www.instagram.com/horisun4/"
//           }].map((icon, i) => (
//             <div
//               key={i}
...
//             >
//               {icon.move && (
//                 <div className="h-[30px] w-[100px] flex rounded-[40px] items-center justify-center bg-[#4d61ff] mb-1">
//                   <h1 className="text-[16px]">{icon.label}</h1>
//                 </div>
//               )}
//               <div className="h-[50px] w-[50px] flex items-center justify-center rounded-full bg-[#222426]">
//                 <a
//                   href={icon.link}
...
//                       icon.move ? "h-[100%] w-[100%]" : "h-[40%] w-[40%]"
//                     }`}
...
//           {/* Contact Button */}
//           <div className="rounded-[40px] bg-[#4d61ff] px-4 py-2 text-[15px]">
//             (+234) 916 529 7719
//           </div>
//         </div>
...
//       {menuOpen && (
//         <div
//           className="md:hidden flex flex-col items-center gap-6 text-[17px] py-10 bg-cover bg-center"
//           style={{
//             backgroundImage:
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#18181a]/70 text-white z-50">
      <div className="flex items-center justify-between h-[110px] px-6 sm:px-8 lg:px-10 max-w-[1400px] mx-auto">
        ...
        {/* Social + Contact - hidden below 1080px */}
