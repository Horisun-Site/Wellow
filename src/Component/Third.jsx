...
//       {/* Content */}
//       <div className="relative z-10 w-full max-w-6xl flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-10 py-20 sm:py-24 md:py-28">
//         {/* Section Title */}
//         <div className="flex items-center gap-3.5 mb-10 text-center sm:text-left">
//           <h3 className="font-serif font-bold text-3xl sm:text-4xl md:text-5xl">
//             Our
//           </h3>
//           <h3 className="italic font-serif font-bold text-3xl sm:text-4xl md:text-5xl">
//             Services
//           </h3>
//         </div>
...
const Third = () => {
  return (
    <section className="relative bg-black text-white overflow-hidden min-h-screen flex flex-col justify-center items-center">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl flex flex-col items-center justify-center px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-16 sm:py-20 md:py-24 lg:py-28">
        
        {/* Section Title */}
        <div className="flex flex-col sm:flex-row items-center sm:items-end gap-2 sm:gap-3 mb-10 text-center sm:text-left">
        ...
        <div className="flex flex-col gap-10 sm:gap-12 md:gap-14 w-full">
          {/* Row 1 */}
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-8 md:gap-10 lg:gap-12">
            <Caller
              image={react}
              text="React & Tailwind"
              text2="Installation"
