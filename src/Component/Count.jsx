...
const Count = () => {
  ...
  return (
   <div className="flex flex-col items-center justify-center w-full min-h-[50vh] bg-[#0f1112] text-white px-4 py-20">
      {/* Section Header */}
      <div className="text-center flex flex-col gap-[20px] mb-16">
      ...
      <div
        ref={ref}
        className="flex flex-wrap items-center justify-evenly w-full gap-10 md:gap-16 max-w-6xl"
      >
        {[
